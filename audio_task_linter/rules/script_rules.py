...
RULES = [
    RuleInfo("S001", "Script exists and is substantive", ERROR, "deterministic", ("script",),
             "The script is the primary carrier of instructions; it must exist and be more than a one-liner."),
    RuleInfo("S002", "Script gives no cell coordinates", WARNING, "deterministic", ("script",),
             "More than a few exact row/column references turn the debrief into a read-out of cell edits."),
    RuleInfo("S003", "Script names no Excel functions", WARNING, "deterministic", ("script",),
             "An MD says 'look it up off the curve', not 'use an XLOOKUP'."),
    RuleInfo("S004", "Graded tabs exist and were known to the analyst", WARNING, "deterministic", ("rubric", "script", "gold"),
    ...
    RuleInfo("S005", "Script's headline instructions have a criterion", WARNING, "deterministic", ("rubric", "script"),
    ...
    RuleInfo("S006", "Script doesn't say the target values aloud", WARNING, "deterministic", ("rubric", "script"),
             "Output-validation target values should not be spoken in the script (the analyst would then be transcribing, not modelling)."),
    RuleInfo("S007", "AI: every criterion inferable from the script", WARNING, "ai-lint", ("rubric", "script", "input"),
             "LLM pass: classify every criterion Explicit / Inferrable / Anchored against the script + input; Anchored criteria are unfair."),
    RuleInfo("S008", "AI: script and gold agree both ways", WARNING, "ai-lint", ("script", "gold", "input"),
             "LLM pass: every instruction maps to a change in the gold and every gold change traces back to the script."),
    RuleInfo("S009", "AI: every deliverable in the script is tested", WARNING, "ai-lint", ("rubric", "script"),
             "LLM pass: list the deliverables the script asks for and report which have no criterion."),
    RuleInfo("S010", "AI: no PII or private company names", ERROR, "ai-lint", ("script", "rubric", "gold", "input"),
