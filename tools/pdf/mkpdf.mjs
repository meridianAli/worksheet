...
await p.goto('file://' + process.cwd() + '/outlines-print.html', { waitUntil: 'networkidle' });
await p.emulateMedia({ media: 'print' });
await p.waitForTimeout(600);
await p.pdf({
  path: '../../Five-Briefing-Outlines.pdf',
  format: 'Letter',
  ...
  footerTemplate:
    ...
    '<span style="float:left">Five briefing outlines &middot; tasksexport20260904.json</span>' +
