...
await p.goto('file://' + process.cwd() + '/scripts-print.html', { waitUntil: 'networkidle' });
await p.emulateMedia({ media: 'print' });
await p.waitForTimeout(600);
await p.pdf({
  path: '../../Five-Briefing-Scripts.pdf',
  format: 'Letter',
  ...
  footerTemplate:
    ...
    '<span style="float:left">Five briefing scripts &middot; tasksexport20260904.json</span>' +
