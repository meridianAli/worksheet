...
await p.goto('file://' + process.cwd() + '/monologues-print.html', { waitUntil: 'networkidle' });
await p.emulateMedia({ media: 'print' });
await p.waitForTimeout(600);
await p.pdf({
  path: '../../Five-Monologues.pdf',
  format: 'Letter',
  ...
  footerTemplate:
    ...
    '<span style="float:left">Five monologues &middot; tasksexport20260904.json</span>' +
