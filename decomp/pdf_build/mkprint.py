"""Turn ../BANKER_SCENARIOS.md into a standalone, print-ready HTML page.

  python3 fonts.py     # -> fonts-inline.css (IBM Plex latin subsets, base64 woff2)
  python3 mkprint.py   # -> banker-scenarios-print.html
  node    mkpdf.mjs    # -> Banker-Scenarios.pdf
"""
import re, pathlib, markdown

SRC = pathlib.Path(__file__).resolve().parent.parent / "BANKER_SCENARIOS.md"
OUT = pathlib.Path(__file__).resolve().parent / "banker-scenarios-print.html"
